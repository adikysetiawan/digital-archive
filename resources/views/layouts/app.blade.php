...
<head>
    ...
    <title>@yield('title', 'SI-ARSIP DPMPTSP')</title>
    ...
    <div class="app-container">
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <img src="{{ asset('assets/logos/logo_dpmptsp.jpg') }}" alt="Logo DPMPTSP" class="sidebar-logo">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item">
                    <a href="{{ route('documents.index') }}" class="nav-link {{ (request()->routeIs('documents.index') || request()->routeIs('documents.show') || request()->routeIs('documents.edit')) ? 'active' : '' }}">
        ...
        <div class="main-content">
            <div class="top-header">
                <div class="header-left">
                    <h1>@yield('header-title', 'Sistem Informasi Arsip Surat Keputusan')</h1>
                    <p>@yield('header-subtitle', 'Overview & Statistik')</p>
                </div>
