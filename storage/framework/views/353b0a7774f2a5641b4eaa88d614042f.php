...
unset($__errorArgs, $__bag); ?>
                ...
                <form method="POST" action="<?php echo e(route('password.email')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input id="email" type="email" class="input" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus placeholder="Alamat Email">
                    </div>
...
<?php /**PATH C:\laragon\www\arsip-digital\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>