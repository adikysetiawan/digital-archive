...
<?php $__env->startSection('header-subtitle', 'Unggah Dokumen Baru'); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                        <i class="fas fa-circle-exclamation invalid-icon" title="<?php echo e($message); ?>"></i>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      placeholder="Masukkan deskripsi dokumen (opsional)"><?php echo e(old('description')); ?></textarea>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                <i class="fas fa-circle-exclamation invalid-icon" title="<?php echo e($message); ?>" style="top:36px;"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.querySelector('form[action*="documents/store"]') || document.querySelector('form[action$="<?php echo e(route('documents.store')); ?>"]') || document.querySelector('form');
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\arsip-digital\resources\views/documents/create.blade.php ENDPATH**/ ?>